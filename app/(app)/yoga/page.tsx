...
export default function YogaTrainer() {
  ...
  async function sendMessage(e: React.FormEvent) {
    ...
    try {
      ...
      setChat((prev) => [
        ...prev,
        { from: "YOGA TRAINER", text: data.reply },
      ]);
    } catch {
      setChat((prev) => [
        ...prev,
        { from: "YOGA TRAINER", text: "Something went wrong." },
      ]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <main className={styles.container}>
      <h1 className={styles.title}>🧘 AI YOGA TRAINER</h1>
      ...
      <form className={styles.form} onSubmit={sendMessage}>
        <input
          ...
          placeholder="Ask for a yoga routine..."
        />
